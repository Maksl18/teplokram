...
// HTTP
define('HTTP_SERVER', $_ENV['OPENCART_HTTP_SERVER_ADMIN']);
define('HTTP_CATALOG', $_ENV['OPENCART_HTTP_SERVER']);

// HTTPS
define('HTTPS_SERVER', $_ENV['OPENCART_HTTPS_SERVER_ADMIN']);
define('HTTPS_CATALOG', $_ENV['OPENCART_HTTPS_SERVER']);
...
// OpenCart API
define('OPENCART_SERVER', $_ENV['OPENCART_API_SERVER']);
define('OPENCARTFORUM_SERVER', $_ENV['OPENCART_API_FORUM_SERVER']);
